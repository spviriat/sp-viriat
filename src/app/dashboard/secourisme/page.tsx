  ...
  return (
    <div className="app-page">
      <SecourismeSidebar
        ...
        canViewBagAnalytics={canViewBagAnalytics}
      />
...
function SidebarStaticItem({
  ...
  return (
    <div
      title={!open ? label : undefined}
      className={`flex min-h-11 items-center rounded-xl text-sm font-bold text-muted-foreground ${
        open
          ? "gap-3 px-3"
          : "justify-center px-2"
      }`}
